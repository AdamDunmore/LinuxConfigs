    ...
    wayland.windowManager.sway = {
        ...
        config = {
            ...
            keybindings = {
                ...
                "XF86AudioRaiseVolume" = "exec patctl set-sink-volume @DEFAULT_SINK@ +5%";
                "XF86AudioLowerVolume" = "exec patctl set-sink-volume @DEFAULT_SINK@ -5%";
                "XF86AudioMute" = "exec patctl set-sink-volume @DEFAULT_SINK@ 0%";
